#ifndef __aStarPathPlanningAndObstacleAvoidanceInWarehouse_sfun_h__
#define __aStarPathPlanningAndObstacleAvoidanceInWarehouse_sfun_h__
...
extern mxArray*
  load_aStarPathPlanningAndObstacleAvoidanceInWarehouse_optimization_info
  (boolean_T isRtwGen, boolean_T isModelRef, boolean_T isExternal);
extern void
  unload_aStarPathPlanningAndObstacleAvoidanceInWarehouse_optimization_info(void);
