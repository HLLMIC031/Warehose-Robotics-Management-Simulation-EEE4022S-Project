  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_aStarPathPlanningAndObstacleAvoidanceInWarehouse_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_aStarPathPlanningAndObstacleAvoidanceInWarehouse_third_party_uses_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "aStarPathPlanningAndObstacleAvoidanceInWarehouse") ==
      0) {
  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "aStarPathPlanningAndObstacleAvoidanceInWarehouse") ==
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_aStarPathPlanningAndObstacleAvoidanceInWarehouse_jit_fallback_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_aStarPathPlanningAndObstacleAvoidanceInWarehouse_get_post_codegen_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
...
{
  if (!strcmp(machineName,"aStarPathPlanningAndObstacleAvoidanceInWarehouse")) {
    return(sf_aStarPathPlanningAndObstacleAvoidanceInWarehouse_method_dispatcher
...
extern void aStarPathPlanningAndObstacleAvoidanceInWarehouse_terminator(void);
void sf_machine_global_terminator(SimStruct* S)
{
  (void)S;
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    aStarPathPlanningAndObstacleAvoidanceInWarehouse_terminator();
  }

  return;
}

extern void aStarPathPlanningAndObstacleAvoidanceInWarehouse_initializer(void);
extern void
  aStarPathPlanningAndObstacleAvoidanceInWarehouse_register_exported_symbols
  (SimStruct* S);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  aStarPathPlanningAndObstacleAvoidanceInWarehouse_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    aStarPathPlanningAndObstacleAvoidanceInWarehouse_initializer();
  }
