#ifndef __aSPPAOAIW_sfun_h__
#define __aSPPAOAIW_sfun_h__
...
extern mxArray* load_aSPPAOAIW_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_aSPPAOAIW_optimization_info(void);
